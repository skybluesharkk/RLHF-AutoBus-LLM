...
# fine-tuned 모델 ID (예: training 후 반환된 모델 ID를 사용)
fine_tuned_model = "ft:gpt-4o-mini-2024-07-18:llm:mytestv2:BAlmUPiQ"
...
if __name__ == "__main__":
    ...
    user_input = input("자연어 명령을 입력하세요: ")
    start = time.time()
    result = controller.get_command(user_input)
    end = time.time()
    print("변환 결과:", result)
